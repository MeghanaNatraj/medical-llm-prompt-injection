...
results = {
    ...
    "Medical Hijack":    {"delta": 0.8784, "min_delta": 0.6763, "success_rate": 14.4},
    "Stealth Attack":    {"delta": 0.8850, "min_delta": 0.6673, "success_rate": None},
    "Brand Manip.":      {"delta": 0.8782, "min_delta": 0.6487, "success_rate": 95.5},
    "Task Switch":       {"delta": 0.8092, "min_delta": 0.5375, "success_rate": 46.8},
}
